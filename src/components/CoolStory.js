...
class CoolStory extends React.Component {
    ...
    onSlideChange = (event) => this.setState(({ idxCurrent }) => {
        ...
        this.setState({
            idxDiff: this.props.stories[this.state.idxCurrent].category === "image" ?
                3000 : this.props.stories[this.state.idxCurrent].duration * 1000
        })
    })
    componentDidMount() {
...
export default connect(mapStateToProps)(CoolStory);
